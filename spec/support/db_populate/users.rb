RSpec.configure do |config|
  ...
  config.before(:all) do
    ...
    @read_external_order_applicant = create(:permission, name: 'read_external_order_applicant', permission_module: @pm_oe_applicant)
    @create_external_order_applicant = create(:permission, name: 'create_external_order_applicant', permission_module: @pm_oe_applicant)
    @update_external_order_applicant = create(:permission, name: 'update_external_order_applicant', permission_module: @pm_oe_applicant)
    @destroy_external_order_applicant = create(:permission, name: 'destroy_external_order_applicant', permission_module: @pm_oe_applicant)
    @send_external_order_applicant = create(:permission, name: 'send_external_order_applicant', permission_module: @pm_oe_applicant)
    @receive_external_order_applicant = create(:permission, name: 'receive_external_order_applicant', permission_module: @pm_oe_applicant)
    @return_external_order_applicant = create(:permission, name: 'return_external_order_applicant', permission_module: @pm_oe_applicant)

    # Deposito other establishment
    @pm_oe_provider = create(:permission_module, name: 'Ordenes Externas Proveedor')
    @read_external_order_provider = create(:permission, name: 'read_external_order_provider', permission_module: @pm_oe_provider)
    @create_external_order_provider = create(:permission, name: 'create_external_order_provider', permission_module: @pm_oe_provider)
    ...
    @products.each_with_index do |product, index|
      ...
      LotStock.create(quantity: rand(5000..10000), lot: lot, stock: stock)
    end
  end
end