def internal_orders_applicant_populate
  10.times do
    ...
    order=InternalOrder.new(provider_sector_id: @depo_applicant.active_sector.id, applicant_sector_id: @farm_applicant.active_sector.id,
  ...
  10.times do
    charset = Array('A'..'Z') + Array('a'..'z')
    remit_code = Array.new(20) { charset.sample }.join
    order=InternalOrder.new(provider_sector_id: @depo_applicant.active_sector.id + 1, applicant_sector_id: @farm_applicant.active_sector.id,
