...
RSpec.feature 'ChronicPrescriptions', type: :feature do
  before(:all) do
  ...
  describe '', js: true do
    ...
    describe 'Permission:' do
      ...
      it 'Edit: form and fields' do
        chronic_prescription = ChronicPrescription.where(status: 'pendiente').first
    ...
    #     within '#original-order-product-cocoon-container' do
    #       expect(page).to have_field(
    #         'chronic_prescription[original_chronic_prescription_products_attributes][0][request_quantity]', type: 'number', with: 10
    #       )
    #     end
    #   end
