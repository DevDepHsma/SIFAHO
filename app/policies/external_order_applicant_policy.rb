class ExternalOrderApplicantPolicy < ApplicationPolicy
  ...
  def destroy?(resource)
    if resource.solicitud? && resource.solicitud_auditoria? && resource.applicant_sector == user.active_sector
  ...
  def edit_products?(resource)
    return unless resource.solicitud_auditoria? && resource.applicant_sector == user.active_sector
  ...
  #   edit?(resource) && resource.persisted? && resource.added_by_sector_id.present? && resource.added_by_sector != user.active_sector
  # end
