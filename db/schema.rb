...
ActiveRecord::Schema.define(version: 2022_09_09_232112) do
  ...
  create_table "external_order_baks", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
    t.bigint "applicant_sector_id"
    t.bigint "provider_sector_id"
    t.bigint "audited_by_id"
  ...
  create_table "internal_order_baks", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
    t.bigint "provider_sector_id"
    t.bigint "applicant_sector_id"
    t.bigint "audited_by_id"
  ...
  create_table "office_supplies", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
    t.string "name"
    t.text "description"
    t.integer "quantity"
  ...
  create_table "office_supply_categorizations", id: false, force: :cascade do |t|
    t.bigserial "id", null: false
  ...
  create_table "permission_users", force: :cascade do |t|
    ...
    t.index ["sector_id"], name: "index_permission_users_on_sector_id"
    t.index ["user_id"], name: "index_permission_users_on_user_id"
  end

  create_table "permissions", force: :cascade do |t|
    t.string "name"
    t.bigint "permission_module_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["permission_module_id"], name: "index_permissions_on_permission_module_id"
  end
